...
<html lang="en">
	...
	<head>
	    ...
	    <meta name="description" content="Each week we will honor one of our students who has shown exceptional progress, a great attitude or a love for music. They get a free t-shirt and a cool video showcasing their skills.">
		<meta name="keywords" content="">
		<meta name="author" content="">


	    <title>Student Of The Week - A Major Music</title>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 centered">
							...
							<p class="section-title">Students of the Week</p>

							<!--<h2 class="section-heading">Student of the Week</h2>-->
