...
<html lang="en">
	...
	<head>
	    ...
	    <meta name="description" content="Are you a good guitar player who wants a great high paying part time job? Read more and apply today. We offer free training so experience is not required.">
		<meta name="keywords" content="">
		<meta name="author" content="">


	    <title>Apply To Become An A Major Guitar Instructor</title>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-12">
						...
						<a href="http://amajorguitarlessons.com/<?= ($city) ?>/" class="logo"><img src="/images/logo-a-major-horizontal.png" alt="A Major Logo"></a> <!-- Your Logo -->
							...
							<div class="vertical-center-content">
								...
								<div class="hero-content row centered">
									...
									<!--<p class="lead all-caps text-shadow-small margin-bot-30" data-sr="enter bottom over 1s and move 50px wait 0.4s">Hello Visitor, This is Urip..</p>-->
										<!--<button onclick="goBack()" class="lead all-caps text-shadow-small margin-bot-30" data-sr="enter bottom over 1s and move 50px wait 0.4s">Click To Go Back To Your City Page!</button>-->
