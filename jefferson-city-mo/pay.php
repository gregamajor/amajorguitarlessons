...
<html lang="en">
	...
	<head>
	    ...
	    <meta name="description" content="This page explains all the different payment options that are available to you. Credit cards, debit cards, and e-check (ACH) are our preferred methods. If you have any questions just ask.">
		<meta name="keywords" content="">
		<meta name="author" content="">


	    <title>Pay For your A Major Guitar Lessons</title>
  	...
  	<body>
		...
		<nav id="nav-wrapper">
			...
			<ul id="main-nav" class="main-nav all-caps">
				<li><a href="http://amajorguitarlessons.com/<?= ($city) ?>/index/">Your City</a></li>				
			<?= ($citypaesnavlinks) ?>
