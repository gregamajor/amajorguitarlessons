...
// Teacher Profile pics
$CityTeacherPic1 = 'city-Greg-Weinecke-Guitar-Instructor-Music-Lessons.jpg" alt="Greg Weinecke Profile Picture">';


$CityTeacherPic2 = 'city-greg-instructing.jpg" alt="Greg Teaching">';

// Teacher Bio part 1
$CityTeacher1Bio1 = '
    <h3>Ian McEuen</h3>
    <h6>Guitar, Bass, Ukulele, Theory, Improvisation and Song Writing Instructor in the '.$cityname.' area.</h6>
<!--NEED TO MAKE AN INSTRUCTOR PAGE FOR BIGGER SCREENS-->
<!--<p><a href="#0" class="more">See Full Bio</a></p>-->
    <p>Ian McEuen is a professional and trained music instructor from Fredericktown, Missouri. He is been playing music since he was 15. He started playing on his brothers old acoustic guitar and has not stopped since.</p>
    <p>Ian loves helping his students have get good at guitar and customizing his lesson plans to each person. He likes to teach the people the techniques they need through the songs they love.</p>
    <p>He loves and plays many genres of music such as: blues, rock, metal, pop, jazz, funk, and folk. With a strong penchant for soloing and talent for inventiveness he has trained himself in the art of live looping. He certainly has dedicated much of his time to music and shows no signs of stopping.</p>
';
// Teacher Bio part 2
$CityTeacher1Bio2 = '<p>Aside from music, in his free time Ian is an avid video gamer. From The Legend of Zelda to The Elder Scrolls, he has spent many hours enjoying classic video games.</p>
