...
<html lang="en">
	...
	<head>
		...
		<meta name="author" content="">
	     ...
	     <title>In-Home Guitar Lessons - A Major Music</title>
  	...
  	<body>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-12">
						...
						<a href="/" class="logo"><img src="/images/logo-a-major-horizontal.png" alt="A Major Logo"></a> <!-- Your Logo -->
		...
		<nav id="nav-wrapper">
			...
			<li class="current"><a href="#hero">Home</a></li>
				...
				<li><a href="#featurettes">Instructor Info</a></li>
							...
							<div class="vertical-center-content">
								...
								<div class="hero-content row">
									<div class="col-lg-6 col-md-6 col-sm-6 margin-top-50">
										...
										<h2 class="text-shadow-medium" data-sr="enter top over 1s and move 50px wait 0.3s">Personalized Music Lessons for all ages and styles in your home!</h2>
										
										<p class="lead zero-bottom text-shadow-xsmall" data-sr="enter top over 1s and move 50px wait 0.4s">More Affordable and Convenient Lessons<br>Just $20 for a half hour lesson a week!</p>
...
<section id="what-we-do" class="centered">
	...
	<div class="container">
		...
		<h4 class="section-heading"><a href="http://www.amajormusiclessons.com/">Columbia MO (All Instruments)</a></h4>
		<h4 class="section-heading"><a href="/st-charles-mo/">St. Charles MO (Guitar and Piano Lessons)</a></h4>
		<h4 class="section-heading"><a href="/kansas-city-mo/">Kansas City MO (Guitar Lessons)</a></h4>
		<h4 class="section-heading"><a href="/lees-summit-mo/">Lee's Summit MO (Guitar Lessons)</a></h4>
		<h4 class="section-heading"><a href="/springfield-mo/">Springfield MO (Guitar Lessons)</a></h4>
		<h4 class="section-heading"><a href="/jefferson-city-mo/">Jefferson City MO (Guitar Lessons)</a></h4>
		</div> <!--/ .col-lg-8 -->
					...
					<div class="row">
						...
						<div class="expandable-gallery-wrapper col-lg-6 col-md-6 no-padding">
							...
							<ul class="expandable-gallery-item">
								<li class="selected"><img src="/images/Greg-Weinecke-Guitar-Instructor-Music-Lessons.jpg" alt="Greg Weinecke Profile Picture"></li>
								<li><img src="/images/greg-instructing.jpg" alt="Greg Teaching"></li>
								<li><img src="/images/Group Lesson Photo.jpg" alt="Teaching a Group Guitar Lesson"></li>
