...
<html lang="en">
	...
	<head>
	    ...
	    <title>Teacher Certification Quiz</title>
...
<span class="animated-words-wrapper">
    <b class="is-visible">A Major Music Lessons<br>Teacher Certification Quiz</b>
<!--<b>Tuition</b>
<b>Transfers</b>-->
...
<li data-sr="enter left  over 1s wait 0.3s">-->
    <div><a href="#what-we-do" class="cta cta-stroke all-caps scroll-to">Continue to Quiz</a></div>
		...
		<h1>A Major Music Teacher Certification Quiz</h1>
		
		<form action="quiz-results.php" method="post" id="quiz">
		
            <ol>
            
                <li>
                
                    <h4>1. What do you do, if you hit traffic on the way to your last in-home lesson of the day, and will arrive at 7:13pm instead of the regular lesson time of 7pm.</h3>
                    
                    <div>
                        <input type="radio" name="question-1-answers" id="question-1-answers-A" value="A" />
                        <label for="question-1-answers-A">A) Text the student to let them know you will be a little late. </label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-1-answers" id="question-1-answers-B" value="B" />
                        <label for="question-1-answers-B">B) Nothing, that is within your normal arrival window. </label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-1-answers" id="question-1-answers-C" value="C" />
                        <label for="question-1-answers-C">C) Call the Student and let them know. </label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-1-answers" id="question-1-answers-D" value="D" />
                        <label for="question-1-answers-D">D) Reschedule the lesson because it will be too late by the time you get there. </label>
                    </div>
                ...
                <li>
                    ...
                    <h3>2. What do you do, if you hit traffic on the way to your last in-home lesson of the day, and will arrive at 7:20pm instead of the regular lesson time of 7pm. </h3>
                    
                    <div>
                        <input type="radio" name="question-2-answers" id="question-2-answers-A" value="A" />
                        <label for="question-2-answers-A">A) Text the student to let them know you will be a little late. </label>
                    </div>
                ...
                <li>
                    ...
                    <h3>3. What do you do, if you hit traffic on the way to your last in-home lesson of the day, and will arrive at 7:40pm instead of the regular lesson time of 7pm. </h3>
                    
                    <div>
                        <input type="radio" name="question-3-answers" id="question-3-answers-A" value="A" />
                        <label for="question-3-answers-A">A) Text the student to let them know you will be a little late. </label>
                    </div>
                ...
                <li>
                    ...
                    <h3>4. What do you do, if you hit traffic on the way to your first in-home lesson of the day, and will arrive at 7:30pm instead of the regular lesson time of 7pm. </h3>
                    
                    <div>
                        <input type="radio" name="question-4-answers" id="question-4-answers-A" value="A" />
                        <label for="question-4-answers-A">A) Text the student to let them know you will be a little late. </label>
                    </div>
                ...
                <li>
                    ...
                    <h3>5. What do you do, if you accidentally teach your last studio lesson of the night an extra 10 minutes. </h3>
                    
                    <div>
                        <input type="radio" name="question-5-answers" id="question-5-answers-A" value="A" />
                        <label for="question-5-answers-A">A) Text the student to let them know you will be a little late. </label>
                    </div>
