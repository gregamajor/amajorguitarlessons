...
<html lang="en">
	<head>
	    ...
	    <title>A Major Guitar Lessons</title>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-12">
						...
						<a href="https://worksofwisnu.com/theme-preview/urip/index-hero-form.html" class="logo"><img src="images/logo-a-major-horizontal.png" alt="A Major Logo"></a> <!-- Your Logo -->
							...
							<div class="vertical-center-content">
								...
								<div class="hero-content row">
									<div class="col-lg-6 col-md-6 col-sm-6 margin-top-50">
										...
										<h2 class="text-shadow-medium" data-sr="enter top over 1s and move 50px wait 0.3s">Personalized Guitar Lessons for all ages and styles in your home!</h2>
										
										<p class="lead zero-bottom text-shadow-xsmall" data-sr="enter top over 1s and move 50px wait 0.4s">How A Major Music Lessons work</p>
										
										<div class="row">
											<div class="col-lg-10">

												<div class="embed-responsive embed-responsive-16by9" data-sr="enter bottom over 1s and move 75px">
													<iframe width="470" height="264" src="https://www.youtube.com/embed/Wxsrjj09fuI?rel=0" frameborder="0" allowfullscreen></iframe>
										...
										<form class="register-form margin-top-5 margin-bot-5" id="register-form" method="post">
											<div class="row">
												...
												<div class="col-lg-6 col-md-6">
													<div class="required-field">
														<input name="heroUsername" id="hero-username" class="hero-input"  type="text" placeholder="Email Address">
													</div> <!--/ .required-field -->
												</div>

												<div class="col-lg-6 col-md-6">
													<div class="required-field">
														<input name="heroEmail" id="hero-email" class="hero-input"  type="text" placeholder="Phone Number">
													</div> <!--/ .required-field -->
												</div>

												
												<!--from the pop up form--> 
												<!--<div class="required-field">
												...
												<!--messed with-->
												<div class="col-lg-12 col-md-12">
													<input name="heroPhone" id="hero-phone" class="hero-input message-greg"  type="text" placeholder="Message">
												</div>
					...
					<div class="row">
						...
						<div class="col-lg-12">
							...
							<div class="attention-box">
								...
								<p><strong>Phone:(847) 807-1800 -</strong> Address: 906 W Ash St, Columbia, MO 65203</p>
					...
					<div class="row">
						...
						<div class="expandable-gallery-wrapper col-lg-6 col-md-6 no-padding">
							...
							<ul class="expandable-gallery-item">
								...
								<li><img src="images/stocks/guitar-blue.jpg" alt="Photo Stocks"></li>
