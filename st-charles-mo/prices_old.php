	...
	<head>
  	...
  	<body>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 centered">
							...
							<p class="section-title">Pricing Info</p>

							<h2 class="section-heading">Payments and Pricing options</h2>
		...
		<?= ($PricePageContent1) ?>
				<?= ($price) ?>
		<?= ($PricePageContent2) ?>
				<a href="https://amajorguitarlessons.com/<?= ($city) ?>/pay/">Click Here to Pay or for More Info</a>
		<?= ($PricePageContent2b) ?>
				<?= ($PriceCityInHomeGroup) ?>
		<?= ($PricePageContent3) ?>
				<?= ($PriceCityInHomeGroup) ?>
		<?= ($PricePageContent4) ?>
				<?= ($PriceCityInHomeGroup) ?>		
