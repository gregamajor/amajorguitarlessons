...
$plans = [
// Only Creates a Customer account 
    'register_card_only' => [
        'cost'         => 000,
        'title'        => 'No immediate charges',
        'description'  => 'Click the "Sign Up" button to make an account with us. This will only register your card, and we will contact you before charges are made.'
    ],
];
...
?>
	...
	<head>
	    ...
	    <title>Create An Account And Pay Later</title>
...
<div class="col-lg-12">
    <h1 class="animated-headline slide margin-top-40" data-sr="enter bottom over 1s and move 50px wait 0.3s">
        <span class="animated-words-wrapper">
            <b class="is-visible"><?php echo $selectedPlan['title']; ?> <br>were made</b>
        </span> <!--/ .animated-words-wrapper -->
    </h1>
        <h2>You've just successfully created an account! <br>Someone will be in contact with you soon <br>to confirm and make the charges</h2>
            <h3>You'll receive a receipt at <br><?php echo $_POST['stripeEmail']; ?></h3>
</div> <!--/ .col-lg-12 -->
</div> <!--/ .row -->
    <?php
    mail('contact@amajor.net', 'New Customer: '.$_POST['stripeEmail'], 'Someone filled out the creat an account only stripe form. Contact them at ' . $_POST['stripeEmail'] . ', confirm the charges, and charge them.');
    ...
    mail(
        ...
        'Thank you for creating an account. You will not be charged anything until we contact you and confirm the charge, or if we previously discussed and confirmed an amount with you, then we will charge that amount as soon as we can. <br /><br /> If you have any questions, please let us know.<br /><br />Contact us at: <br /> contact@amajor.net<br />(847) 807-1800',
        $headers
    );
...
<div class="col-lg-12">
    <h1 class="animated-headline slide margin-top-40" data-sr="enter bottom over 1s and move 50px wait 0.3s">
        <span class="animated-words-wrapper">
            <b class="is-visible">Error</b>
        </span> <!--/ .animated-words-wrapper -->
    </h1>
        <h2>There was a problem creating your account; <br>your account has not been created.</h2>
...
<div class="col-lg-12">
    <h1 class="animated-headline slide margin-top-40" data-sr="enter bottom over 1s and move 50px wait 0.3s">
        <span class="animated-words-wrapper">
            <b class="is-visible"><?php echo $selectedPlan['title']; ?></b>
        </span> <!--/ .animated-words-wrapper -->
    </h1>
